...
class _ScreenState extends State<Screen> {
  ...
  Future<void> _onTap(ApplicationMeta app) async {
    ...
    /*final a = await UpiPay.initiateTransaction(
      amount: "1.00" , //_amountController.text,
      app: app.upiApplication,
      receiverName: 'ISundarakani',
      receiverUpiAddress: 'sundarakani.business@okhdfcbank', //_upiAddressController.text,
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion =
          await FlutterPluginGpay.platformVersion ?? 'Unknown platform version';
